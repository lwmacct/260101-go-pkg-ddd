...
import (
	...
	auditDomain "github.com/lwmacct/260101-go-pkg-ddd/ddd/core/domain/audit"
...
func (h *AuditHandler) GetActions(c *gin.Context) {
	...
	actions := toApplicationAuditActions(routes.AllAuditActions())
	categories := toApplicationCategoryOptions(routes.AllAuditCategories())
...
func toApplicationAuditActions(src []routes.AuditActionDefinition) []audit.AuditActionDefinition {
...
// toApplicationCategoryOptions 将 routes.CategoryOption 转换为 application/audit.CategoryOption
func toApplicationCategoryOptions(src []routes.CategoryOption) []audit.CategoryOption {
