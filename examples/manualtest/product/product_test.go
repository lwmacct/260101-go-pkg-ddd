...
import (
	...
	"github.com/lwmacct/260101-go-pkg-ddd/examples/manualtest"
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductCRUD ./internal/integration/product/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductListPagination ./internal/integration/product/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductStatusToggle ./internal/integration/product/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductPriceUpdate ./internal/integration/product/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductWithInvalidData ./internal/integration/product/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestProductFilterByStatus ./internal/integration/product/
