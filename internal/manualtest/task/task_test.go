...
import (
	...
	"github.com/lwmacct/260101-go-pkg-ddd/pkg/modules/core/application/task"
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTaskCRUD ./internal/integration/task/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTaskStatusTransition ./internal/integration/task/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTaskInvalidStatusTransition ./internal/integration/task/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTaskWithAssignee ./internal/integration/task/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTaskOrgTeamIsolation ./internal/integration/task/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestListTasks ./internal/integration/task/
