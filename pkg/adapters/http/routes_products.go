...
func (deps *RouterDependencies) productRoutes() []routes.Route {
	...
	return []routes.Route{
		// ==================== Admin 域 - 产品管理 ====================
		{
			...
			Op:          permission.AdminProductsCreate,
		...
		},
		{
			...
			Op:          permission.AdminProductsList,
		...
		},
		{
			...
			Op:          permission.AdminProductsGet,
			Middlewares: baseMiddlewares,
			Tags:        "Admin - Products",
			Summary:     "产品详情",
			Description: "获取产品详情",
		},
		{
			...
			Op:          permission.AdminProductsUpdate,
			Middlewares: auditMiddlewares,
			Tags:        "Admin - Products",
			Summary:     "更新产品",
			Description: "更新产品信息",
		},
		{
			...
			Op:          permission.AdminProductsDelete,
			Middlewares: auditMiddlewares,
			Tags:        "Admin - Products",
			Summary:     "删除产品",
			Description: "删除产品",
