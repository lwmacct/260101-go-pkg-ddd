...
func (deps *RouterDependencies) orgRoutes() []routes.Route {
	...
	return []routes.Route{
		...
		},
		{
			...
			Op:          permission.OrgMembersRemove,
			Middlewares: orgAuditMiddlewares,
			Tags:        "Org - Members",
			Summary:     "移除成员",
			Description: "移除组织成员",
		},
		{
			...
			Op:          permission.OrgMembersUpdateRole,
			Middlewares: orgAuditMiddlewares,
			Tags:        "Org - Members",
			Summary:     "更新成员角色",
		...
		// ==================== Org 域 - 团队成员管理 ====================
		{
			...
			Op:          permission.OrgTeamMembersList,
			Middlewares: orgTeamGetMiddlewares,
			Tags:        "Org - Teams",
			Summary:     "团队成员列表",
		...
		},
		{
			...
			Op:          permission.OrgTeamMembersAdd,
			Middlewares: orgTeamAuditMiddlewares,
			Tags:        "Org - Teams",
			Summary:     "添加团队成员",
			Description: "添加团队成员",
		},
		{
			...
			Op:          permission.OrgTeamMembersRemove,
			Middlewares: orgTeamAuditMiddlewares,
			Tags:        "Org - Teams",
			Summary:     "移除团队成员",
			Description: "移除团队成员",
