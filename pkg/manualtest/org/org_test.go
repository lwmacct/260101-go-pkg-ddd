...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgCRUD ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgListPagination ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgStatusUpdate ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgMemberCRUD ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgMemberLastOwnerProtection ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestUserOrgs ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestOrgWithInvalidData ./internal/manualtest/org/
