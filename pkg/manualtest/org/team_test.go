...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamCRUD ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamListByOrg ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamOrgIsolation ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamMemberCRUD ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamMemberRequiresOrgMembership ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestUserTeams ./internal/manualtest/org/
...
// 手动运行:
//
//	MANUAL=1 go test -v -run TestTeamWithInvalidOrgID ./internal/manualtest/org/
